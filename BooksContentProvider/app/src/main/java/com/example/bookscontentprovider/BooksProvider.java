...
{
    public static final String PROVIDER_NAME = "com.example.bookscontentprovider";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion,int newVersion) {
            Log.w("Contentprovider","Upgrading database from version " +oldVersion + " to " + newVersion +", which will destroy all old data");
    ...
    public int delete(Uri arg0, String arg1, String[] arg2) {
        ...
        switch (uriMatcher.match(arg0)){
            case BOOKS:
                ...
                break;
            case BOOK_ID:
                String id = arg0.getPathSegments().get(1);//retrieves the id from uri
                count = booksDB.delete(
                        DATABASE_TABLE,
                        _ID + " = " + id +
